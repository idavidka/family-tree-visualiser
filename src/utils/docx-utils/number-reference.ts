...
export class NumberReferenceFieldInstruction extends XmlComponent {
	public constructor(
		bookmarkId: string,
		...
		let instruction = `REF ${bookmarkId} \\r`;
...
export class NumberReference extends Run {
	public constructor(
		bookmarkId: string,
		...
		super({
			children: [
				new Begin(true),
				new NumberReferenceFieldInstruction(bookmarkId, {
					useRelativePosition,
					hyperlink,
				}),
				new End(),
